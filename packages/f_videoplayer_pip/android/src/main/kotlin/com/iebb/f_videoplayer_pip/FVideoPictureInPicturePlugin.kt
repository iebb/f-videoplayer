...
/** Included Android implementation of F Video Player's shared system-PiP channel. */
class FVideoPictureInPicturePlugin : FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {
    ...
    private fun remoteActions(): List<RemoteAction> {
        ...
        val iconResource = if (playing) R.drawable.f_video_pip_pause else R.drawable.f_video_pip_play
    ...
    private fun actionIntentName(): String =
        "${activity?.packageName ?: "com.iebb.f_videoplayer"}.f_video.PICTURE_IN_PICTURE_ACTION"
    ...
    companion object {
        private const val CHANNEL_NAME = "f_videoplayer/picture_in_picture"
        private const val EXTRA_ID = "f_video_pip_id"
        private const val EXTRA_ACTION = "f_video_pip_action"
        private const val ACTION_PLAY = "play"
        private const val ACTION_PAUSE = "pause"
        private const val MIN_ASPECT_RATIO = 0.45
        private const val MAX_ASPECT_RATIO = 2.35
        private var currentPlugin: WeakReference<FVideoPictureInPicturePlugin>? = null
