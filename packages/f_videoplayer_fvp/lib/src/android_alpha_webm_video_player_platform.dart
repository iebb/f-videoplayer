...
/// Keeps regular Android video on the primary backend while routing local
/// WebM files through FVP's alpha-capable software decoder.
final class AndroidAlphaWebmVideoPlayerPlatform extends VideoPlayerPlatform {
  AndroidAlphaWebmVideoPlayerPlatform({
    required this.primaryBackend,
    required this.alphaWebmBackend,
  });

  final VideoPlayerPlatform primaryBackend;
  final VideoPlayerPlatform alphaWebmBackend;
  ...
  Future<int?> createWithOptions(VideoCreationOptions options) async {
    final backend = isAndroidAlphaWebmDataSource(options.dataSource)
        ? alphaWebmBackend
        : primaryBackend;
  ...
  Future<void> setMixWithOthers(bool mixWithOthers) async {
    ...
    await alphaWebmBackend.setMixWithOthers(mixWithOthers);
  }
...
bool isAndroidAlphaWebmDataSource(DataSource dataSource) {
