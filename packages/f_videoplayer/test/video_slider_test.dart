...
void main() {
  testWidgets('timeline maps taps across its usable width', (tester) async {
    ...
    final rect = tester.getRect(find.byType(FVideoSlider));
  ...
  testWidgets('tap and drag report complete change lifecycles', (tester) async {
    ...
    await tester.tap(find.byType(FVideoSlider));
    expect(events, ['start', 'change', 'end']);

    events.clear();
    await tester.drag(find.byType(FVideoSlider), const Offset(80, 0));
