...
FVideoDesktopWindowArguments? _tryParseArguments(
  Object? source, {
  ...
  return encoded == null
      ? null
      : FVideoDesktopWindowArguments.tryParse(encoded, windowType: windowType);
}
  ...
  Future<void> _configure() async {
    try {
      ...
      await window.setTitle(
        FVideoDesktopWindowArguments.normalizeTitle(widget.arguments.title),
      );
      await window.center();
    } on Object {
