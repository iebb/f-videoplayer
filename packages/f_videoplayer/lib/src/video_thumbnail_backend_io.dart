...
Future<Uint8List?> generateThumbnail({
  ...
  if (source.kind == FVideoSourceKind.asset || source.httpHeaders.isNotEmpty) {
    return Future<Uint8List?>.value();
  }

  final network = source.kind == FVideoSourceKind.network;
  ...
  if (source.kind == FVideoSourceKind.file && Platform.isAndroid) {
