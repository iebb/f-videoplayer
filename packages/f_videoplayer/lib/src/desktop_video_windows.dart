...
bool get fVideoSupportsDesktopVideoWindows =>
    FVideoDesktopWindows.instance.isSupported;

/// Owns independent desktop windows and their host-side resources.
class FVideoDesktopWindows {
  FVideoDesktopWindows._(this._platform);

  static final FVideoDesktopWindows instance = FVideoDesktopWindows._(
    implementation.createDesktopWindowsPlatform(),
  );

  final FVideoDesktopWindowsPlatform _platform;
  ...
  FVideoDesktopWindowErrorHandler? get onError => _platform.onError;
  ...
  static Future<FVideoDesktopWindowArguments?> initialize(
