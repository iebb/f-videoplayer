...
class FVideoSlider extends StatefulWidget {
  const FVideoSlider({
    super.key,
    required this.value,
  ...
  @override
  State<FVideoSlider> createState() => _FVideoSliderState();
}

class _FVideoSliderState extends State<FVideoSlider> {
  ...
  @override
  void didUpdateWidget(covariant FVideoSlider oldWidget) {
...
class _FVideoSliderPainter extends CustomPainter {
  const _FVideoSliderPainter({
    required this.value,
  ...
  @override
  bool shouldRepaint(_FVideoSliderPainter oldDelegate) =>
